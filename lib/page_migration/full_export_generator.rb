  ...
  class FullExportGenerator
    ...
    def render_tree_node(page, prefix, is_last)
      ...
      children.each_with_index do |child, idx|
        ...
        # we should probably always render the node or at least its indentation.
        # For the tree view, it's better to show the full path if we want to see where custom pages are.
