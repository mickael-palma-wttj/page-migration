...
# See: https://github.com/rails/solid_queue/issues/99
...
# In development, always run Solid Queue in Puma for convenience.
# In production, use ENV["SOLID_QUEUE_IN_PUMA"] or run a separate worker process.
